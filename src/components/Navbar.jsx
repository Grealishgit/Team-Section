    ...
    return (
        <div className='fixed flex w-full top-0 z-80 justify-between items-center border-white/20 backdrop-blur-md bg-white/10 md:p-3 p-3'>
            ...
            <nav className='md:flex hidden space-x-4'>
                ...
                <p onClick={() => navigate('/projects')} className='text-white text-lg relative cursor-pointer hover:text-green-600 group'>Projects
                    <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                </p>
                <p onClick={() => navigate('/team')} className='text-white text-lg relative cursor-pointer hover:text-green-600 group'>Team
                    <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                </p>
                <p onClick={() => navigate('/about')} className='text-white text-lg relative cursor-pointer hover:text-green-600 group'>About
                    <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                </p>
            ...
            <div className={`absolute top-16 right-10 bg-black/50 w-60 backdrop-blur-xl border border-white/20 rounded-lg shadow-lg p-4 ${isOpen ? 'block' : 'hidden'} md:hidden`}>
                <nav className='flex flex-col items-center space-y-4'>
                    <p onClick={() => { navigate('/'); setIsOpen(!isOpen) }} className='text-white relative cursor-pointer text-lg hover:text-green-600 group'>Home
                        <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                    </p>
                    <p onClick={() => { navigate('/projects'); setIsOpen(!isOpen) }} className='text-white text-lg relative cursor-pointer hover:text-green-600 group'>Projects
                        <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                    </p>
                    <p onClick={() => { navigate('/team'); setIsOpen(!isOpen) }} className='text-white text-lg relative cursor-pointer hover:text-green-600 group'>Team
                        <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                    </p>
                    <p onClick={() => { navigate('/about'); setIsOpen(!isOpen) }} className='text-white text-lg relative cursor-pointer hover:text-green-600 group'>About
                        <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                    </p>
                    <p onClick={() => { navigate('/contact'); setIsOpen(!isOpen) }} className='text-white text-lg relative cursor-pointer hover:text-green-600 group'>Contact
                        <span className="absolute left-0 bottom-0 h-0.5 bg-green-500 w-0 group-hover:w-full transition-all duration-300" />
                    </p>
                </nav>
